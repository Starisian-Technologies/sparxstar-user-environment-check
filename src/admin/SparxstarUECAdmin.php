    ...
    public function render_snapshot_viewer_section(): void
    {
        try {
            ...
            try {
                ...
                StarLogger::error('SparxstarUECAdmin', $display_error, ['method' => 'render_snapshot_viewer_section', 'context' => 'snapshot_display']);
            ...
            StarLogger::error('SparxstarUECAdmin', $throwable, ['method' => 'render_snapshot_viewer_section', 'context' => 'snapshot_retrieval']);
            echo '<div class="notice notice-error inline">';
            echo '<p><strong>' . esc_html__('Snapshot retrieval failed:', 'sparxstar-user-environment-check') . '</strong> ' . esc_html($throwable->getMessage()) . '</p>';
